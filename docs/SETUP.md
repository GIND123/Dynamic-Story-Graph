# Setup, datasets, weights, and training

Operational guide for reproducing the runs: environment bootstrap, the six
git-hosted corpora, the two Hugging Face corpora, model weights, and the Modal
training path. Research results and their interpretation live in
[`README.md`](../README.md); method specification in
